...
<div id="content">
	...
	<div class="category-title-left">
		<h3>
			<?php
				if ( is_day() ){
					printf( __('Архив за <em>%s</em>', 'greentheme'), get_the_date('d F Y') );
				}
				elseif ( is_month() ){
					printf( __('Архив за <em>%s</em>', 'greentheme'), get_the_date('F Y')  );
				}
				elseif ( is_year() ){
					printf( __('Архив за <em>%s</em>', 'greentheme'),  get_the_date('Y'));
				}
				else {
					_e( 'Архив', 'greentheme' );
				}
